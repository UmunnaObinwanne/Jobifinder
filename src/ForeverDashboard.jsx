...
import Sidebar from "./DashboardComponents/SidebarComponent/Sidebar";

function ForeverDashboard() {
  return (
    <>
        ...
        <div className="p-4 xl:ml-80">
          ...
          <div className="mt-12 w-full">
            <div className="mt-12 w-full">
              <div className="mt-12">
                <div>
                  <div className="mb-6 flex gap-y-10 gap-x-6 md:grid-cols-2">
                    <section className="py-2 bg-violet-400 text-gray-900 w-full">
                      {" "}
                      {/* Adjusted padding */}
                      <div className="flex flex-col items-center justify-center p-2 space-y-4 md:p-4 md:px-6 xl:px-12">
                        {" "}
                        {/* Adjusted padding */}
                        <p className="pt-2 pb-4 text-3xl font-medium text-center">
                          Are You Recruiting?
                        </p>
                        <button className="px-40 py-2 text-md font-semibold rounded bg-gray-800 text-gray-50">
                          {" "}
                          {/* Increased width */}
                          Post a New Job
                        </button>
...
export default ForeverDashboard;
